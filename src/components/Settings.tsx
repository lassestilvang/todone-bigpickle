...
export const Settings: React.FC<SettingsProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-4xl max-h-[90vh] bg-white rounded-lg shadow-xl flex flex-col dark:bg-zinc-800"
          ...
          <div className="flex-1 overflow-auto p-6 dark:bg-zinc-800">
            ...
            {activeTab === "general" && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-4 dark:text-zinc-100">
                    General
                  </h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateSetting("startOfWeek", e.target.value)
                        }
                        className="input w-full"
                      >
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-700">
                          Automatically add time to new tasks
                        </span>
                      </label>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <button
                        ...
                        onClick={() =>
                          updateSetting("theme", themeOption.value)
                        }
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        updateSetting("keyboard.enabled", e.target.checked)
                      }
                      className="rounded"
                    />
                    <span className="text-sm text-gray-700 dark:text-zinc-300">
                  ...
                  {settings.keyboard.enabled && (
                    <div className="space-y-3">
                      ...
                      {Object.entries(settings.keyboard.shortcuts).map(
                        ([action, shortcut]) => (
                          <div
                            key={action}
                    ...
                    <div className="space-y-2">
                      ...
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            updateSetting(
                              "productivity.distractionBlocking",
                              e.target.checked,
                            )
                          }
                          className="rounded"
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      {exportStatus && (
                        <p
                          className={`text-xs mt-1 ${exportStatus.includes("success") ? "text-green-600" : "text-red-600"}`}
                        >
                          {exportStatus}
                        </p>
                      )}
                    ...
                    <div>
                      ...
                      {importStatus && (
                        <p
                          className={`text-xs mt-1 ${importStatus.includes("success") ? "text-green-600" : "text-red-600"}`}
                        >
                          {importStatus}
                        </p>
                      )}
